            ...
            <div class="as-search-results as-filter-open as-category-landing as-desktop" id="as-search-results">
                ...
                <div id="accessories-tab" class="as-accessories-details">
                    <div class="as-accessories" id="as-accessories">
                        ...
                        <div class="as-searchnav-placeholder" style="text-align:center;">
							<h2>
								Tu pago ha sido aprobado
							</h2>
							<h3>
								Aquí está la información de la compra:
							</h3>

							<p>
								<strong>payment_method_id que se usó para pagar:</strong> <?php echo $mpResponse["body"]["payment_method_id"]; ?>
							</p>

							<p>
								<strong>Monto pagado:</strong> <?php echo $mpResponse["body"]["transaction_details"]["total_paid_amount"]; ?>
							</p>
